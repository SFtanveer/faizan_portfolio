...
export default function Example({ open, onClose, content }) {
          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              ...
              <button
                ...
                data-autofocus
                onClick={onClose}
                className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-gray-300 ring-inset sm:mt-0 sm:w-auto transition-all duration-400 ease-in-out active:border-gray-500 hover:border-gray-500  active:bg-gray-500 active:text-white hover:bg-gray-500 hover:text-white"
              >
                Cancel
              </button>
            </div>
